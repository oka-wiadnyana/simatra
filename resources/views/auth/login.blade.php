            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="text-center m-0">
                        <a href="{{ url('/') }}" class="logo logo-admin"><img src="{{ asset('img') }}/simatra text.png" height="30" alt="logo"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-muted font-18 m-b-5 text-center">Welcome Back !</h4>
                        <p class="text-muted text-center">Sign in to continue to Simatra.</p>
                            ...
                            <div class="form-group row m-t-20">
                                <div class="col-6">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="customControlInline" name="remember_me" value="Y">
