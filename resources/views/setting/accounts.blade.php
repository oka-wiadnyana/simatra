        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-20">
                    ...
                    <div class="row mb-2">
                        <div class="col ">
                            <h4 class="mt-0 header-title">Daftar Akun</h4>
                        
                        </div>
                        <div class="col  d-flex justify-content-end">
                            <div>

                                <x-partial.button text="Tambah" onClick="showModal('modal-add-account'); return false"/>
                            </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $account->role }}</td>
                                    <td>{{ $account->satker->name }}</td>
                                    
                                    <td><x-partial.button text="Edit" onClick="showModal('modal-edit-account',{{ $account->id }}); return false"/> <x-partial.button text="Hapus" color="danger" onClick="deleteData('{{ url('setting/delete_satker') }}',{{ $account->id }}); return false"/></td>
