...
<x-layout.main :breadcrumbList="$breadcrumbList">
    ...
    @endpush
<x-slot:page_title>
    Laporan Bulanan {{ $satker_data->nick_name }}
</x-slot:page_title>
            ...
            <div class="col">
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Laporan Bulanan {{ $satker_data->nick_name }}</h4>
...
@push('footer')
    ...
    <script>
        ...
        function dataTable(report_id){
          ...
          processing: true,
          serverSide: true,
          ajax: `{{ url('get_monthly_report_satker/'.$satker_data->id) }}/${report_id}`,
          columns: [
