                    ...
                    <div class="row">
                        ...
                        <div class="col  d-flex justify-content-end">
                            <div>
                                ...
                                <x-partial.button text="Tambah" onClick="showModal('modal-add-quarterly-report',{{ $report_id }}); return false"/>
                            </div>
...
<livewire:modal-quarterly-report />
@push('footer')
    ...
    <script>
        $('#datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('get_quarterly_report/'.$report_id) }}",
          columns: [
