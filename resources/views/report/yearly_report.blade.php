                    ...
                    <div class="row">
                        ...
                        <div class="col  d-flex justify-content-end">
                            <div>
                                ...
                                <x-partial.button text="Tambah" onClick="showModal('modal-add-yearly-report',{{ $report_id }}); return false"/>
                            </div>
...
@push('footer')
    ...
    <script>
        $('#datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('get_yearly_report/'.$report_id) }}",
          columns: [
