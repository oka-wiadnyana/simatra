                    ...
                    <div class="row">
                        ...
                        <div class="col  d-flex justify-content-end">
                            <div>
                                ...
                                <x-partial.button text="Tambah" onClick="showModal('modal-add-semester-report',{{ $report_id }}); return false"/>
                            </div>
...
<livewire:modal-semester-report />
@push('footer')
    ...
    <script>
        $('#datatable').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('get_semester_report/'.$report_id) }}",
          columns: [
